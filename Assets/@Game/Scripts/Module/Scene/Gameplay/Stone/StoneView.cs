...
namespace ProjectAdvergame.Module.Stone
{
    public class StoneView : BaseView
    {
        ...
        public void SetMove(Sequence sequence)
        {   
            sequence.Join(transform.DOMove(new Vector3(0, 0, zIndex + index), duration).SetEase(Ease.Linear).SetUpdate(UpdateType.Fixed).OnComplete(() => {
